...
class FeedReport extends StatefulWidget {
  ...
  @override
  State<FeedReport> createState() => _FeedReportState();
}

class _FeedReportState extends State<FeedReport> {
  Future<List<ReportModel>?>? report;
  HomeServices homeServices = HomeServices();
  ProfileServices profileServices = ProfileServices();
  @override
  void initState() {
    super.initState();
    report = homeServices.fetchReportsList(context);
  }
              ...
              onTap: () {
                AppFunctions.showDialogueBox(
                  ...
                  ReportAlert(
                    ...
                    onTap: (status) {
                      if (status) {
                        if (widget.reportUser) {
                          profileServices.reportUser(widget.userId ?? "",
                              model[index].id ?? "", context);
                        } else {
                          homeServices.reportVideo(
